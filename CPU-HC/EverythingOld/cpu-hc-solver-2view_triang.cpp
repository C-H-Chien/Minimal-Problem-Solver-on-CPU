#ifndef cpu_hc_solver_2view_triang_cpp
#define cpu_hc_solver_2view_triang_cpp
// =====================================================================================
// CPU-HC Solver for 5-view triangulation problem
//
// Modifications
//    Chiang-Heng Chien  22-12-16:   Initially Created. Copied from the 5-view triangulation problem
//
// ======================================================================================
#include <stdio.h>
#include <stdlib.h>
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-2view_triang.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-2view_triang.h"
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.0000001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_2view_triang(s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_2view_triang( s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
