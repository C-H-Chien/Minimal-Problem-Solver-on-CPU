#ifndef cpu_hc_solver_5pt_rel_pos_eight_unkwns_cpp
#define cpu_hc_solver_5pt_rel_pos_eight_unkwns_cpp
// =====================================================================================
// CPU-HC Solver for 5-points relative pose estimation problem (Essential Matrix Eight Unknowns)
//
// Modifications
//    Chiang-Heng Chien  22-11-22:   Initially Created. Copied from the algebraic form
//
// ======================================================================================
#include <stdio.h>
#include <stdlib.h>
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-5pt_rel_pos_eight_unkwns.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-5pt_rel_pos_eight_unkwns.h"
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.0000001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_5pt_rel_pos_eight_unkwns(s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_5pt_rel_pos_eight_unkwns( s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
