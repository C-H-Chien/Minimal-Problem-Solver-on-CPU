...
#include "./eval_dHdx_dHdt/cpu-eval-dHdX_dHdt_trifocal_2op1p_30x30.hpp"
#include "./eval_dHdx_H/cpu-eval-dHdX_H_trifocal_2op1p_30x30.hpp"
...
public:
    ...
    real_Double_t HomotopyContinuation(const int num_of_cores, const Eval_dHdX_dHdt& Eval_dHdX_dHdt_func, const Eval_dHdX_H& Eval_dHdX_H_func );
