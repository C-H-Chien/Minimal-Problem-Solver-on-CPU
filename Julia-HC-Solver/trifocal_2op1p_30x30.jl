...
#> solutions(R) will be the converged HC solutions

#> Write start solutions, start parameters, target solutions, etc to files
#io = open("/path/to/your/output/file.txt", "w");
